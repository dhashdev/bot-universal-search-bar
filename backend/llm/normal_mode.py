from backend.utils.tools import GoogleSearchHandler
from .base_chain import BaseChain
from backend.config.settings import settings
from backend.prompts import (decision_human_prompt, decision_system_prompt,
...
class AnswerPredictor:
    def __init__(self):
        ...
        self.search_tools = GoogleSearchHandler(google_api_key=settings.search_api.GOOGLE_API_KEY,
                                                google_cse_id=settings.search_api.GOOGLE_CSE_ID)
